...
{
    /// <inheritdoc />
    public partial class InitialAuthAndVendor : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Location_Area = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Location_AddressLine = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    ...
                    CurrentVerificationRequestId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VerificationRequests_VendorProfiles_VendorProfileId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("7f2a1c1e-0001-4a00-8000-000000000001"), true, "Venue" },
                    { new Guid("7f2a1c1e-0001-4a00-8000-000000000002"), true, "Photographer" },
                    { new Guid("7f2a1c1e-0001-4a00-8000-000000000003"), true, "Decorator" },
                    { new Guid("7f2a1c1e-0001-4a00-8000-000000000004"), true, "Caterer" },
                    { new Guid("7f2a1c1e-0001-4a00-8000-000000000005"), true, "DJ" },
                    { new Guid("7f2a1c1e-0001-4a00-8000-000000000006"), true, "MakeupArtist" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VendorCategories_Name",
                table: "VendorCategories",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VendorDocuments_VerificationRequestId",
                table: "VendorDocuments",
                column: "VerificationRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_VendorImages_VendorProfileId",
                table: "VendorImages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VendorProfiles_CurrentVerificationRequestId",
                table: "VendorProfiles",
                column: "CurrentVerificationRequestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VerificationRequests_VendorProfileId_SubmittedAt",
                table: "VerificationRequests",
                columns: new[] { "VendorProfileId", "SubmittedAt" });

            migrationBuilder.AddForeignKey(
                name: "FK_VendorDocuments_VerificationRequests_VerificationRequestId",
                table: "VendorDocuments",
                column: "VerificationRequestId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_VendorImages_VendorProfiles_VendorProfileId",
                table: "VendorImages",
                column: "VendorProfileId",
                principalTable: "VendorProfiles",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_VendorProfiles_VerificationRequests_CurrentVerificationRequestId",
                table: "VendorProfiles",
                column: "CurrentVerificationRequestId",
                principalTable: "VerificationRequests",
                principalColumn: "Id",
